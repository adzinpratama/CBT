 ...
 * @author Hilmi-Adzin
 */
public final class SiswaOperator extends javax.swing.JInternalFrame {

    /**
     * Creates new form MenuUser
     */
    String id_user = session.get_id_user();
    public SiswaOperator() {
        initComponents();
        datatable();
    ...
    private void initComponents() {
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "nama", "nim" }));
        ...
        jButton3.setText("Refresh Login");
    ...
    private void jTextField6KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField6KeyReleased
        ...
        try {
            ...
            ResultSet res = statement.executeQuery("select * from siswa inner join kelas using(id_kelas) where "+pilih+"='"+jTextField6.getText()+"'");
            DefaultTableModel tbl= new DefaultTableModel();
            tbl.addColumn("NIS");
            tbl.addColumn("Nama");
            tbl.addColumn("Kelas");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        String nis = jTextField7.getText();
        try {
            Statement statement= (Statement)conek.GetConnection().createStatement();
            statement.executeUpdate("update siswa set status='off' where nis='"+nis+"'");
            datatable();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, e);
        }
